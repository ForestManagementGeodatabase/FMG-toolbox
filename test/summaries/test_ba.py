...
def test_float():
    ...
    ba_float = fmgpy.summaries.forest_calcs.ba(ba_2, 1)
...
def test_ba_2_plots_3_trees():
    ...
    assert fmgpy.summaries.forest_calcs.ba(ba_6, 2) == 15
...
def test_ba_3_plots_3_trees():
    ...
    assert fmgpy.summaries.forest_calcs.ba(ba_7, 3) == 10
