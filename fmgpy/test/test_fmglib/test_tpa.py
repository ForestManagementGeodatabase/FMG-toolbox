...
def test_float():
    ...
    tpa_float = fmgpy.fmglib.forest_calcs.tpa(tpa_2)
...
def test_tpa_0_plots_0_trees():
    ...
    assert fmgpy.fmglib.forest_calcs.tpa(tpa_0) is None
...
def test_tpa_1_plots_0_trees():
    tpa_1 = pd.DataFrame({"PID": [1],
                          ...
                          "TR_DIA": [0]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [1]
    assert fmgpy.fmglib.forest_calcs.tpa(tpa_1) == 0
...
def test_tpa_1_plot_1_trees():
    tpa_2 = pd.DataFrame({"PID": [1],
                          ...
                          "TR_DIA": [10]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [1]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_2)
...
def test_tpa_1_plot_2_trees():
    tpa_3 = pd.DataFrame({"PID": [1, 1],
                          ...
                          "TR_DIA": [5, 15]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [1]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_3)
...
def test_tpa_2_plots_na_trees():
    ...
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_4)
...
def test_tpa_2_plots_3_trees():
    tpa_5 = pd.DataFrame({"PID": [1, 2, 2],
                          ...
                          "TR_DIA": [5, 5, 30]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [2]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_5)
...
def test_tpa_2_plots_2_trees():
    tpa_6 = pd.DataFrame({"PID": [1, 2],
                          ...
                          "TR_DIA": [15, 10]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [2]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_6)
...
def test_tpa_2_plots_3_trees():
    tpa_7 = pd.DataFrame({"PID": [1, 2, 2],
                          ...
                          "TR_DIA": [15, 15, 11]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [2]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_7)
...
def test_tpa_2_plots_11_trees():
    ...
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [2]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_8)
...
def test_tpa_3_plots_3_trees():
    tpa_9 = pd.DataFrame({"PID": [1, 2, 3],
                          ...
                          "TR_DIA": [20, 30, 40]})
    # density = sum of BAF [10] / Tree Basal Area (.005454 x DBH^2) [0.05] / Plots [2]
    density = fmgpy.fmglib.forest_calcs.tpa(tpa_9)
