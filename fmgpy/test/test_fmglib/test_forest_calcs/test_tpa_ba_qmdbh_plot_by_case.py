...
def test_itself():
    ...
    csv_folder_path = './dataframe_test_csvs/tpa_ba_qmdbh_plot_by_case/'
    ...
    tbq_table_1 = fcalc.tpa_ba_qmdbh_plot_by_case(tree_table, filter_statement, case_column)
    ...
    case_column = 'SP_TYPE'
    tbq_table_2 = fcalc.tpa_ba_qmdbh_plot_by_case(tree_table, filter_statement, case_column)
