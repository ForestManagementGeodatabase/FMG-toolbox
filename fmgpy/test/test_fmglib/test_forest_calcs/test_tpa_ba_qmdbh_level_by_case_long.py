...
def test_itself():
    ...
    csv_folder_path = './dataframe_test_csvs/tpa_ba_qmdbh_level_by_case_long/'
    ...
    tbq_table_1 = fcalc.tpa_ba_qmdbh_level_by_case_long(tree_table, filter_statement, case_column, 'PID')
    ...
    case_column = 'SP_TYPE'
    tbq_table_2 = fcalc.tpa_ba_qmdbh_level_by_case_long(tree_table, filter_statement, case_column, 'POOL')
